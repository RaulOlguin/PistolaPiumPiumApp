...
fun SettingsDialog(
    ...
    var tempVibrationLevel = remember { mutableStateOf(config.vibrationLevel) }
    var tempEnableFlashlight = remember { mutableStateOf(config.enableFlashlight) }
    var tempSoundVolume = remember { mutableStateOf(config.soundVolume) }
